    ...
    <v-app-bar app color="transparent" class="blurred-nav" flat>
      <v-container>
        <v-row align="center" justify="space-between">
          ...
          <v-col cols="auto" class="d-flex align-center d-md-none pr-8">
            <img src="/logo_main.png" alt="Allometrik" style="max-height: 50px; min-width: 50px;" class="mr-1" />
            <NuxtLink to="/" class="text-decoration-none">
              <h1 class="text-h4 font-weight-bold" style="font-family: 'Montserrat', sans-serif; color: black !important;">allometrik</h1>
            </NuxtLink>
          </v-col>
          <v-col cols="auto" class="d-none d-md-flex align-center justify-center">
            <img src="/logo_main.png" alt="Allometrik" style="max-height: 50px; min-width: 50px;" class="mr-1" />
            <NuxtLink to="/" class="text-decoration-none">
              <h1 class="text-h4 font-weight-bold" style="font-family: 'Montserrat', sans-serif; color: black !important;">allometrik</h1>
            </NuxtLink>
          ...
          <v-col cols="auto" class="d-none d-md-flex">
            <v-btn text class="nav-link" @click="scrollToSection('services-section')" style="color: black;">Services</v-btn>
            <v-btn text class="nav-link" @click="scrollToSection('process-section')" style="color: black;">Process</v-btn>
          </v-col>
        </v-row>
      </v-container>
    </v-app-bar>
      ...
      <v-container class="py-12">
        <v-row justify="center" align="start">
          ...
          <v-col cols="12" sm="6" md="4" class="text-center text-sm-left mb-8 mb-md-0">
            ...
            <div class="d-flex flex-column footer-links">
              <a class="footer-link mb-3" @click="scrollToSection('services-section')">
                <span class="arrow-icon">→</span>
                Services
              </a>
              <a class="footer-link mb-3" @click="scrollToSection('process-section')">
                <span class="arrow-icon">→</span>
                Process
              </a>
            </div>
        ...
        <v-row justify="space-between" align="center" class="copyright-bar">
          ...
          <v-col cols="12" sm="auto" class="text-center text-sm-right">
            <NuxtLink to="/privacy-policy" class="footer-legal-link mr-4">Privacy Policy</NuxtLink>
            <NuxtLink to="/terms-of-service" class="footer-legal-link">Terms of Service</NuxtLink>
          </v-col>
        </v-row>
      </v-container>
    </v-footer>
